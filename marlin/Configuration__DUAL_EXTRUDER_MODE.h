...
#ifndef MOTHERBOARD
  #define MOTHERBOARD 34 // REPLIKEO DUAL (SINGLE:33)
#endif

// Define this to set a custom name for your generic Mendel,
#define CUSTOM_MENDEL_NAME " Replikeo Bowden Dual " // REPLIKEO
...
#define TEMP_SENSOR_1 1 // REPLIKEO DUAL (SINGLE:0)
